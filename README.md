...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/motuclient-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11285&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/motuclient-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `motuclient` can be installed with:

```
conda install motuclient
```

It is possible to list all of the versions of `motuclient` available on your platform with:
